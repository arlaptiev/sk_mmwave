-- If true, set all settings. Else, skip
set_data = false
...
periodicity = 125--1000 = speed1 -- is in milliseconds -- decrease this if you increase the robot speed (by the same multiplicitive factor) used to be 125 Tara changed it to 100 on Aug 14
-- Record 8 chirps = 65536 bytes in cf.json
if (ar1.FrameConfig(0, 0, 110, 1, periodicity, 0, 0, 1) == 0) then
